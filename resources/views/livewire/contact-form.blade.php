            ...
            <div class="flex-1 lg:-mx-6 lg:flex lg:items-center">
                <div class="text-white lg:mx-6 lg:w-1/2">
                    ...
                    <div class="mt-6 space-y-8 md:mt-8">
                        <p class="-mx-2 flex items-start">
                            ...
                            <span class="mx-2 w-100 truncate text-white">
                        ...
                        <p class="-mx-2 flex items-start">
                            ...
                            <a class="mx-2 min-w-min truncate text-white border-bottom-on-hover-dark"
                    ...
                    <div class="mt-6 md:mt-8">
                        ...
                        <div class="-mx-1.5 mt-4 flex">
                            ...
                            <a class="mx-1.5 transform text-white transition-colors duration-300 hover:text-blue-500"
                               href="{{ config('app.facebook_url') }}" target="_blank">
                            ...
                            <a class="mx-1.5 transform text-white transition-colors duration-300 hover:text-blue-500"
                               href="{{ config('app.linkedin_url') }}" target="_blank">
                                <svg class="h-8 w-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                ...
                <div class="mt-8 lg:mx-6 lg:w-1/2">
                    <div
                        ...
                        @if(session('success'))
                            <div wire:key="{{ rand() }}">
                                <div id="alert-1" x-data="{ show: true }" x-show="show" x-transition
                        ...
                        <form wire:submit.prevent="submit" class="mt-6">
                            <div class="flex-1">
                                <label for="name" class="mb-2 block text-sm text-gray-600 dark:text-gray-200">Full
                                    Name</label>
                                <input type="text" placeholder="John Doe" id="name" wire:model="name"
                                ...
                                @error('name') <span
                                    class="mt-2 text-xs text-red-600 dark:text-red-400">{{ $message }}</span> @enderror
                            </div>

                            <div class="mt-6 flex-1">
                                <label for="email" class="mb-2 block text-sm text-gray-600 dark:text-gray-200">Email
                                    address</label>
