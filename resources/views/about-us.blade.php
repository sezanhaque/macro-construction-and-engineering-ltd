<x-app-layout>
    ...
    <section class="about-us-hero-section hero h-screen flex items-center justify-center text-center">
        <div class="text-center px-6">
            ...
            <a href="#story"
               class="mt-8 inline-block text-lg font-medium bg-gradient-to-r from-purple-500 to-indigo-600 text-white py-3 px-6 rounded-2xl shadow-lg hover:from-indigo-600 hover:to-purple-500 hover:-translate-y-1 transition-all duration-500">More
                About Us</a>
        </div>
    </section>
        ...
        <div class="w-full max-w-7xl px-4 md:px-5 lg:px-5 mx-auto">
            <div class="w-full justify-start items-center xl:gap-12 gap-10 grid lg:grid-cols-2 grid-cols-1">
                <div class="w-full flex-col justify-center lg:items-start items-center gap-10 inline-flex">
                    ...
                    {{--                    <button--}}
                    {{--                        class="sm:w-fit w-full group px-3.5 py-2 bg-indigo-50 hover:bg-indigo-100 rounded-2xl shadow-[0px_1px_2px_0px_rgba(16,_24,_40,_0.05)] transition-all justify-center items-center flex">--}}
                    {{--                        <span--}}
    ...
    <section class="py-14 lg:py-24 relative">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative ">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-9">
                <div class="img-box">
                    <img src="{{ asset("/images/airplane.jpg") }}" alt="About Us"
                         width="500" height="500"
                         class="max-lg:mx-auto object-cover rounded-2xl">
                </div>
    ...
    <section class="py-14 lg:py-24 relative">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative ">
            <div class="grid grid-cols-1 lg:grid-cols-2 lg:gap-9 ">
                ...
                <div class="lg:pr-24 flex items-center mb-6 md:mb-0">
                    <div class="data w-full">
                        ...
                        <h2 class="font-manrope font-bold text-4xl lg:text-5xl text-slate-900 dark:text-gray-300 mb-9 max-lg:text-center">
                            We've been Creative Since 2022</h2>
                        <p class="font-normal text-xl leading-8 text-gray-500 max-lg:text-center max-w-2xl mx-auto">
                ...
                <div class="img-box flex justify-center">
                    <img src="{{ asset("/images/completed-projects/jashore-airport.jpeg") }}" alt="About Us"
                         width="450" height="450"
                         class="block object-cover rounded-2xl">
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="flex gap-5">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-xs text-gray-500 leading-5">Our very talented team members are the powerhouse
                                of paged one and pillars of our success. </p>
                        </div>
                    </div>
                </div>
                <div
                    ...
                    <div class="flex gap-5">
                        ...
                        <div class="flex-1">
                            <h4 class="text-xl text-slate-900 dark:text-gray-300 font-semibold mb-2">Projects
                                Completed</h4>
                            <p class="text-xs text-gray-500 leading-5">We have achieved more than 50 projects, and we
                ...
                <div class="swiper-wrapper">
                        ...
                        <div
                            ...
                            <div class="text-center lg:text-left lg:max-w-xs flex-1">
                                <div class="mb-5 pb-5 border-b border-solid border-gray-300">
                                    <h6
                                        class="text-lg text-slate-900 dark:text-gray-300 font-semibold mb-1">Syed Badre
                                        Alam
                                    </h6>
                                ...
                                <p class="text-gray-500 leading-6 mb-7">
                                    ...
                                    development and sourcing over 25 years.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div
                            ...
                            <div class="text-center lg:text-left lg:max-w-xs flex-1 flex flex-col justify-between">
                                <div class="mb-5 pb-5 border-b border-solid border-gray-300">
                                    <h6 class="text-lg text-slate-900 dark:text-gray-300 font-semibold mb-1">
                                        Md. Touhidul Alam Nishar
                                    </h6>
                                    <span
                                ...
                                <p class="text-gray-500 leading-6 mb-7">
                                    ...
                                    in all of its external affairs and manage the work of the company.
                                </p>
                                <div
                                    class="flex items-center gap-4 justify-center lg:justify-start max-sm:bottom-0 relative">
                                    <a href="https://www.facebook.com/people/Touhidul-Alam/pfbid0SHFpYkA2wzhb56P7kmV7meMTZeBDbeiZtecZjXaAyyVWNfN6QxbFcJN23G2LFb8Ql/"
                                       target="_blank"
                    ...
                    <div class="swiper-slide">
                        <div
                            ...
                            <div class=" w-full lg:w-48 h-64">
                                <img
                                    src="{{ asset("/images/people/Nusrat Jahan Nipu Architectural Consultant and Advisor.jpg") }}"
                                    alt="image"
                                    class="rounded-2xl h-full object-cover mx-auto lg:mx-0 lg:w-full">
                            </div>
                            <div class="text-center lg:text-left lg:max-w-xs flex-1">
                                <div class="mb-5 pb-5 border-b border-solid border-gray-300">
                                    ...
                                    <span class="text-sm text-gray-500 group-hover:text-indigo-600">Architectural Consultant and Advisor</span>
                                </div>
                                <p class="text-gray-500 leading-6 mb-7">
                                    Nusrat Jahan Nipu has truly succeeded in Architectural Consultant and Advisor with a
                                    balancing act and
                                    maintains the respect of team and superiors, also put on a good face for the company
                                    in all of its external affairs and manage the work of the company.
                                </p>
                    ...
                    <div class="swiper-slide">
                        <div
                            class="group w-full flex-wrap flex items-center gap-8 flex-col md:flex-row transition-all duration-500 p-8 lg:flex-nowrap">
                            <div class=" w-full lg:w-48 h-64 max-lg:max-w-[204px] max-lg:mx-auto">
                                <img src="{{ asset("/images/people/pronob-chakma.jpg") }}" alt="image"
                                     class="rounded-2xl h-full object-cover mx-auto lg:mx-0 lg:w-full">
                            </div>
                            <div class="text-center lg:text-left lg:max-w-xs flex-1 flex flex-col justify-between">
                                <div class="mb-5 pb-5 border-b border-solid border-gray-300">
                                    ...
                                    <span class="text-sm text-gray-500 group-hover:text-indigo-600">Director</span>
                                </div>
                                <p class="text-gray-500 leading-6 mb-7">
                                    Pranab Chakma is an expert in Electrical Engineering with an experience over 6years.
                                    He has started his career with Walton.).
                                    With his enriched experience in the Electrical
                                    Section, marketing and manufactures process, he has completed several projects
                                    successfully.
                                </p>
                    ...
                    <div class="swiper-slide">
                        <div
                            ...
                            <div class="text-center lg:text-left lg:max-w-xs flex-1">
                                <div class="mb-5 pb-5 border-b border-solid border-gray-300">
                                    <h6 class="text-lg text-slate-900 dark:text-gray-300 font-semibold mb-1">
                                        Sayedul Haque Sarker
                                    </h6>
                                    <span class="text-sm text-gray-500 group-hover:text-indigo-600">Team Lead, Software Development</span>
                                </div>
                                <p class="text-gray-500 leading-6 mb-7">
                                    In the dynamic realm of software development, Sayedul brings a wealth of expertise
                                    to guide our team towards new horizons.
                                </p>
                                <div class="flex items-center gap-4 justify-center lg:justify-start">
                                    <a href="https://www.facebook.com/sezanhaque"
                                       target="_blank"
                                       class="cursor-pointer text-slate-900 hover:text-white group w-12 h-12 rounded-full flex justify-center items-center bg-gray-100 transition-all duration-500 hover:bg-indigo-600">
                                    ...
                                    {{--                                        </svg>--}}
                                    {{--                                    </p>--}}
                                    <a href="https://www.linkedin.com/in/sayedul-haque-sarker/" target="_blank"
                                       class="cursor-pointer  text-slate-900 dark:text-gray-300 hover:text-white group w-12 h-12 rounded-full flex justify-center items-center bg-gray-100 transition-all duration-500 hover:bg-indigo-600">
                                        <svg class="w-5 h-5" viewBox="0 0 20 19" fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
                                            <path
                    ...
                    <div class="swiper-slide">
                        <div
                            class="group w-full flex-wrap flex items-center gap-8 flex-col md:flex-row transition-all duration-500 p-8 lg:flex-nowrap">
                            <div class=" w-full lg:w-48 h-64 max-lg:max-w-[204px] max-lg:mx-auto">
                                <img src="{{ asset("/images/people/shaon.jpg") }}" alt="image"
                                     class="rounded-2xl h-full object-cover mx-auto lg:mx-0 lg:w-full">
                            </div>
                            <div class="text-center lg:text-left lg:max-w-xs flex-1 flex flex-col justify-between">
                                <div class="mb-5 pb-5 border-b border-solid border-gray-300">
                                ...
                                <p class="text-gray-500 leading-6 mb-7">
                                    Shaon Pradhan is a networking and security engineer with over 3 years of experience
                                    in the IT industry.
                                    He has a strong understanding of networking protocols and
                                    security best practices,
                                    and he is proficient in a variety of networking and
                                    security tools.
                                </p>
                                <div class="flex items-center gap-4 justify-center lg:justify-start">
                                    <a href="https://www.facebook.com/addershoot"
                                       target="_blank"
                                       class="cursor-pointer text-slate-900 hover:text-white group w-12 h-12 rounded-full flex justify-center items-center bg-gray-100 transition-all duration-500 hover:bg-indigo-600">
                                    ...
                                    <a href="https://www.linkedin.com/in/shaon-p-a85666170/" target="_blank"
                                       class="cursor-pointer text-slate-900 dark:text-gray-300 hover:text-white group w-12 h-12 rounded-full flex justify-center items-center bg-gray-100 transition-all duration-500 hover:bg-indigo-600">
                                        <svg class="w-5 h-5" viewBox="0 0 20 19" fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
                                            <path
                    ...
                    <div class="swiper-slide">
                        <div
                            class="group w-full flex-wrap flex items-center gap-8 flex-col md:flex-row transition-all duration-500 p-8 lg:flex-nowrap">
                            <div class=" w-full lg:w-48 h-64 max-lg:max-w-[204px] max-lg:mx-auto">
                                <img src="{{ asset("/images/people/rahi.jpg") }}" alt="image"
                                     class="rounded-2xl h-full object-cover mx-auto lg:mx-0 lg:w-full">
                            </div>
                            <div class="text-center lg:text-left lg:max-w-xs flex-1 flex flex-col justify-between">
                                <div class="mb-5 pb-5 border-b border-solid border-gray-300">
                                    <h6 class="text-lg text-slate-900 dark:text-gray-300 font-semibold mb-1">
                                        Md. Raihanul Hoque Chowdhury
                                    </h6>
                                    <span
                                        class="text-sm text-gray-500 group-hover:text-indigo-600">Team Lead, Civil</span>
                                </div>
                                <p class="text-gray-500 leading-6 mb-7">
                                    BS in Civil & Environmental Engineering, NSU MS in Environmental Science and
                                    Management,
                                    JU Construction and Environmental Consulting Engineer,
                                </p>
                    ...
                    <div class="swiper-slide">
                        <div
                            class="group w-full flex-wrap flex items-center gap-8 flex-col md:flex-row transition-all duration-500 p-8 lg:flex-nowrap">
                            <div class=" w-full lg:w-48 h-64 max-lg:max-w-[204px] max-lg:mx-auto">
                                <img src="{{ asset("/images/people/person.svg") }}" alt="image"
                                     class="rounded-2xl h-full object-cover mx-auto lg:mx-0 lg:w-full">
                            </div>
                            <div class="text-center lg:text-left lg:max-w-xs flex-1 flex flex-col justify-between">
                                <div class="mb-5 pb-5 border-b border-solid border-gray-300">
                                    <h6 class="text-lg text-slate-900 dark:text-gray-300 font-semibold mb-1">
                                        Sheikh Muhammad Muhtashim Abid
                                    </h6>
                                    <span class="text-sm text-gray-500 group-hover:text-indigo-600">Project Manager, Civil</span>
                                </div>
                                <p class="text-gray-500 leading-6 mb-7">
                                    Specialization in Reinforced Concrete Design, Behavior & Design of Metal
                                    Structures & Finite Element Methods of Structural Modeling.
                                </p>
                    ...
                    <div class="swiper-slide">
                        <div
                            class="group w-full flex-wrap flex items-center gap-8 flex-col md:flex-row transition-all duration-500 p-8 lg:flex-nowrap">
                            <div class=" w-full lg:w-48 h-64 max-lg:max-w-[204px] max-lg:mx-auto">
                                <img src="{{ asset("/images/people/shahriar-mahmud.jpg") }}" alt="image"
                                     class="rounded-2xl h-full object-cover mx-auto lg:mx-0 lg:w-full">
                            </div>
                            <div class="text-center lg:text-left lg:max-w-xs flex-1 flex flex-col justify-between">
                                <div class="mb-5 pb-5 border-b border-solid border-gray-300">
                                    ...
                                    <span class="text-sm text-gray-500 group-hover:text-indigo-600">Architect</span>
                                </div>
                                <p class="text-gray-500 leading-6 mb-7">
                                    Graduated from Cittagong University of Engineering & Technology (CUET),
                                    specialization in Reinforced Concrete Design,
                                    Behavior & Design of Metal Structures & Finite Element Methods of Structural
                                    Modeling.
                                </p>
    ...
    @push('styles')
        ...
        <style>
            .about-us-hero-section {
                background: linear-gradient(90deg, rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.5)), url("{{ asset("/images/about-us-hero-section.jpg") }} ") center / cover no-repeat !important;
            }
