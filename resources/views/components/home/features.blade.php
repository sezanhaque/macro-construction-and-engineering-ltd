...
<div class="mx-3 md:mx-20 my-20">
    <div class="grid grid-cols-1 md:grid-cols-3 group bg-white shadow-lg shadow-slate-400 border rounded-t-lg">
        ...
        <div
            class="p-10 flex flex-col items-center text-center group md:border-r md:border-b hover:bg-slate-100 cursor-pointer">
            ...
            <p class="mt-2 text-sm text-slate-500">
                {{ config("app.name") }} is a bunch of highly focused, energetic sets of people.
            </p>
        </div>
        ...
        <div
            ...
            <p class="text-xl font-medium text-slate-700 mt-3">
                Best Project preparation
            </p>
            <p class="mt-2 text-sm text-slate-500">Know where you stand and what next to do to succeed.</p>
        </div>

        <div
            class="p-10 flex flex-col items-center text-center group md:border-b hover:bg-slate-100 cursor-pointer">
            ...
            <p class="text-xl font-medium text-slate-700 mt-3">Project Process Guidance</p>
            <p class="mt-2 text-sm text-slate-500">Professional Advice for Engineering Solution.</p>
        </div>


        <div
            class="p-10 flex flex-col items-center text-center group md:border-r hover:bg-slate-100 cursor-pointer">
        ...
        <div class="p-10 flex flex-col items-center text-center group hover:bg-slate-100 cursor-pointer">
            ...
            <p class="mt-2 text-sm text-slate-500">
                We always try to complete our project in the targeted period of time.
            </p>
        </div>
